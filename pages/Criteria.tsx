  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section id="criteria" className="py-24 bg-white relative overflow-hidden">
        <div className="max-w-[700px] w-[90%] md:w-full mx-auto">
          
          <div className="relative z-10 space-y-20">

            {/* 1. Selection Priorities (우선 선정) */}
            <div className="text-center md:text-left">
                <h2 className="font-sans text-2xl md:text-3xl font-bold tracking-tight leading-tight mb-10 text-eum-dark">
                    이런 분들을<br/> 우선으로 선정합니다
                </h2>
                <ul className="space-y-6 max-w-2xl">
                    <li className="flex items-start gap-4">
                         <div className="mt-1.5 w-5 h-5 rounded-full bg-eum-accent flex items-center justify-center flex-shrink-0 shadow-md">
                            <Check className="w-3 h-3 text-white" />
                         </div>
                         <div>
                             <span className="text-gray-900 text-lg font-bold block mb-1 keep-all">
                                현재 생활권이 분명하고
                             </span>
                    ...
                    <li className="flex items-start gap-4">
                         ...
                         <span className="text-gray-900 text-lg font-bold pt-0.5 keep-all">
                    ...
                    <li className="flex items-start gap-4">
                         ...
                         <div>
                             ...
                             <span className="text-gray-500 text-sm keep-all">
            ...
            <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold mb-8 text-eum-dark text-center md:text-left">이런 분께 추천드립니다</h3>
                <div className="grid sm:grid-cols-2 gap-4">
                    {[
                        ...
                        <div key={i} className="flex flex-col justify-between bg-[#F9F9F9] p-6 rounded-2xl border border-gray-100 hover:border-eum-accent/30 hover:shadow-lg transition-all duration-300 group">
                            <span className="font-eng font-bold text-gray-300 group-hover:text-eum-accent transition-colors text-xl mb-3">{item.num}</span>
                            <span className="text-gray-700 font-bold leading-relaxed keep-all text-base">{item.text}</span>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div>
                ...
                <h3 className="text-xl md:text-2xl font-bold mb-8 text-eum-dark text-center md:text-left">이음로그와 맞지 않을 수 있습니다</h3>
                <div className="space-y-4">
                     {[
                        ...
                        <div key={i} className="flex items-start gap-4 bg-gray-50 p-5 rounded-xl border border-gray-100 hover:bg-white hover:shadow-sm transition-all">
                            <X className="w-4 h-4 text-rose-400 flex-shrink-0 mt-0.5 opacity-80" />
                            <span className="text-gray-600 font-medium leading-relaxed keep-all text-sm md:text-base">{text}</span>
                        </div>
                     ))}
                </div>
            </div>
